...
function SettingsPanel() {
  ...
  useAppStore((s) => s.setMidPanelView);
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Provider", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { defaultValue: model?.provider || "OpenAI", style: inputStyle, children: ["OpenAI", "Anthropic", "Google", "DeepSeek", "Cohere", "Mistral", "本地", "其他"].map(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, style: primaryBtnStyle, children: "保存" })
              ]
            }
          )
        ]
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: suggestions.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--text)" }, children: s.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-tertiary)", marginTop: 1 }, children: s.description })
                  ] })
                ]
              },
              i
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      addMessage({
        ...
        role: "assistant",
        content: "收到你的消息！这是一个模拟的 AI 回复。在实际应用中，这里会通过 CLI 管理器调用 AI 模型生成回复。",
        timestamp: (/* @__PURE__ */ new Date()).toISOString(),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--text-secondary)" }, children: "Claude 3.5 Sonnet" })
                  ]
                }
              )
            ]
